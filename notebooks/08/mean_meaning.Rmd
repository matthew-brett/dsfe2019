...
The dataset is [gender_stats.csv](/dsfe2019/data/gender_stats.csv).
This contains some World Bank statistics for each country on health and
economic factors related to gender equality. See [the data file page](/dsfe2019/data/gender_stats) for more detail.
