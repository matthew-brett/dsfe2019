...
<meta property="og:url" content="https://matthew-brett.github.io/dsfe2019/notebooks/07/pandas_indexing_reprise.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/dsfe2019/notebooks/07/pandas_indexing_reprise.Rmd">
...
You have already seen the [basics of Pandas indexing](/dsfe2019/chapters/07/pandas_indexing); this page is just a reminder of the later
...
page](/dsfe2019/data/rate_my_professors) for more detail.
...
As you have seen in the [Pandas indexing page](/dsfe2019/chapters/07/pandas_indexing), the examples above are the two types of safe
...
complicated.  See [Booleans and labels](/dsfe2019/chapters/07/booleans_and_labels) for more detail.
