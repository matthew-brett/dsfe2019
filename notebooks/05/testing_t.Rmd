...
<meta property="og:url" content="https://matthew-brett.github.io/dsfe2019/notebooks/05/testing_t.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/dsfe2019/notebooks/05/testing_t.Rmd">
...
For example, in the [permutation and t-test page](/dsfe2019/chapters/05/permutation_and_t_test), we asserted that the t-test is not
...
We can pull together the code in [permtuation and t-test page](/dsfe2019/chapters/05/permutation_and_t_test) to implement our own t-test.
...
t-test page](/dsfe2019/chapters/05/permutation_and_t_test):
...
[permtuation and t-test page](/dsfe2019/chapters/05/permutation_and_t_test).
